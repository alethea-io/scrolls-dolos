...
impl Predicate {
    fn tx_match(&self, point: &Point, tx: &Tx) -> Result<bool, WorkerError> {
        match self {
...
fn output_match(tx: &Tx, address_pattern: &AddressPattern) -> Result<bool, WorkerError> {
...
fn withdrawal_match(tx: &Tx, address_pattern: &AddressPattern) -> Result<bool, WorkerError> {
...
fn collateral_match(tx: &Tx, address_pattern: &AddressPattern) -> Result<bool, WorkerError> {
